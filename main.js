...
const generateRandomCharaAssignment = () => { // generate a random message
    ...
    console.log(`Your random character will be a ${randGender} ${randRace} ${randClass}, with the ${randBg} background.`);
}
generateRandomCharaAssignment();